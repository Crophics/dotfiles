...
-- skwd-wall's picker (skwd wall toggle) is no longer bound; reverted to ii's
-- own native wallpaper selector below. Left here in case skwd is wanted back:
-- hl.bind("CTRL + SUPER + T", hl.dsp.exec_cmd("pgrep -x skwd-daemon >/dev/null || (skwd-daemon & sleep 0.5); skwd wall toggle"), { description = "Shell: Change wallpaper (skwd)" })
...
hl.bind("CTRL + Print", hl.dsp.exec_cmd(
    ...
    "notify-send 'Screenshot' 'Saved to Pictures/Screenshots' -a 'Screenshot'"
