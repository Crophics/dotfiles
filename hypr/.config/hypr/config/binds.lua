...
hl.bind(mainMod .. " + Z", hl.dsp.exec_cmd("qs ipc call controlcenter toggle"))
...
hl.bind(mainMod .. " + CONTROL + Right", function() scrollToWorkspace(1) end)
hl.bind(mainMod .. " + CONTROL + Left",  function() scrollToWorkspace(-1) end)
