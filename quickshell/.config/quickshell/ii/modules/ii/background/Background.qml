...
Variants {
    ...
    PanelWindow {
        ...
        property bool wallpaperSizeResolved: false
        ...
        Process {
            ...
            stdout: StdioCollector {
                ...
                onStreamFinished: {
                    ...
                    Qt.callLater(function() { bgRoot.wallpaperSizeResolved = true; });
                }
            }
        }
        ...
        Item {
            ...
            StyledImage {
                ...
                opacity: (status === Image.Ready && bgRoot.wallpaperSizeResolved && !bgRoot.wallpaperIsVideo) ? 1 : 0
                Behavior on opacity {
                    NumberAnimation {
                        duration: 400
                ...
                Behavior on x {
                    enabled: bgRoot.wallpaperSizeResolved
                    NumberAnimation {
                        duration: 600
                        easing.type: Easing.OutCubic
                    }
